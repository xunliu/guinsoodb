...
class RE2 {
 public:
  ...
  guinsoodb_re2::Regexp* Regexp() const { return entire_regexp_; }
 ...
 private:
  ...
  guinsoodb_re2::Prog* ReverseProg() const;

  std::string   pattern_;          // string regular expression
  Options       options_;          // option flags
  std::string   prefix_;           // required prefix (before regexp_)
  bool          prefix_foldcase_;  // prefix is ASCII case-insensitive
  guinsoodb_re2::Regexp*  entire_regexp_;    // parsed regular expression
  guinsoodb_re2::Regexp*  suffix_regexp_;    // parsed regular expression, prefix removed
  guinsoodb_re2::Prog*    prog_;             // compiled program for regexp
  int           num_captures_;     // Number of capturing groups
  bool          is_one_pass_;      // can use prog_->SearchOnePass?

  mutable guinsoodb_re2::Prog*          rprog_;    // reverse program for regexp
...
using guinsoodb_re2::RE2;
using guinsoodb_re2::LazyRE2;
