...
inline guinsoodb_fmt::internal::null<> strerror_r(int, char*, ...) { return {}; }
inline guinsoodb_fmt::internal::null<> strerror_s(char*, std::size_t, ...) { return {}; }
...
FMT_FUNC void internal::error_handler::on_error(const char* message) {
  FMT_THROW(guinsoodb::Exception(message));
}
