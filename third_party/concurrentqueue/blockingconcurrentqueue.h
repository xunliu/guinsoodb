...
{
private:
	typedef ::guinsoodb_moodycamelmoodycamel::ConcurrentQueue<T, Traits> ConcurrentQueue;
	typedef ::guinsoodb_moodycamelmoodycamel::LightweightSemaphore LightweightSemaphore;
