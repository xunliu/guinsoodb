...
typedef struct PGIntervalConstant {
	PGNodeTag type;
	int val_type;         /* interval constant type, either guinsoodb_libpgquery::T_PGString, guinsoodb_libpgquery::T_PGInteger or guinsoodb_libpgquery::T_PGAExpr */
	char *sval;           /* guinsoodb_libpgquery::T_PGString */
	int ival;             /* guinsoodb_libpgquery::T_PGString */
	PGNode *eval;         /* guinsoodb_libpgquery::T_PGAExpr */
