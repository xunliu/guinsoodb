 ...
 *
 *	guinsoodb_libpgquery::T_PGList: lists of pointers
 *		(in practice usually pointers to Nodes, but not always;
 *		declared as "void *" to minimize casting annoyances)
 *	guinsoodb_libpgquery::T_PGIntList: lists of integers
 *	guinsoodb_libpgquery::T_PGOidList: lists of Oids
 *
...
typedef struct PGList {
	PGNodeTag		type;			/* guinsoodb_libpgquery::T_PGList, guinsoodb_libpgquery::T_PGIntList, or guinsoodb_libpgquery::T_PGOidList */
	int			length;
	PGListCell   *head;
	PGListCell   *tail;
} PGList;
