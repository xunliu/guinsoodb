...
//                         GuinsooDB
//
// guinsoodb/optimizer/join_order_optimizer.hpp
//
//
//===----------------------------------------------------------------------===//
...
#include "guinsoodb/optimizer/join_order/query_graph.hpp"
#include "guinsoodb/optimizer/join_order/join_relation.hpp"
