...
//                         GuinsooDB
//
// guinsoodb/common/storage_util.hpp
//
//
//===----------------------------------------------------------------------===//
...
class StorageUtil {
	...
	static uint8_t CalculateCheckSum(guinsoodb::data_ptr buffer, size_t buffer_size) {
	...
	static bool IsValidCheckSum(guinsoodb::data_ptr buffer, size_t buffer_size, uint8_t input_checksum) {
