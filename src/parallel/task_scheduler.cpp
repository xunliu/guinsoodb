...
struct QueueProducerToken {
	...
	guinsoodb_moodycamel::ProducerToken queue_token;
};
...
#else
	throw NotImplementedException("GuinsooDB was compiled without threads! Background thread loop is not allowed.");
#endif
}
...
#else
	throw NotImplementedException("GuinsooDB was compiled without threads! Setting threads is not allowed.");
#endif
}
