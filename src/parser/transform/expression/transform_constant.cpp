...
unique_ptr<ConstantExpression> Transformer::TransformValue(guinsoodb_libpgquery::PGValue val) {
	switch (val.type) {
	...
	case guinsoodb_libpgquery::T_PGBitString: // FIXME: this should actually convert to BLOB
...
unique_ptr<ParsedExpression> Transformer::TransformConstant(guinsoodb_libpgquery::PGAConst *c) {
