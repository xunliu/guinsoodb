...
#define TESTING_DIRECTORY_NAME "guinsoodb_unittest_tempdir"
...
bool CHECK_COLUMN(QueryResult &result_, size_t column_number, vector<guinsoodb::Value> values) {
...
string compare_csv(guinsoodb::QueryResult &result, string csv, bool header) {
