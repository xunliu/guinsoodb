...
#
# This file is part of pyguinsoodb.
#
...
# to remove tests that are for features that are not supported by GuinsooDB.
...
class GuinsooDBTypeTests(unittest.TestCase):
    def setUp(self):
        self.con = guinsoodb.connect(":memory:")
