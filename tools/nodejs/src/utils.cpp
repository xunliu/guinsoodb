...
Napi::Value Utils::CreateError(Napi::Env env, std::string msg) {
	...
	obj.Set(Napi::String::New(env, "errno"), Napi::Number::New(env, Database::GUINSOODB_NODEJS_ERROR));
	obj.Set(Napi::String::New(env, "code"), Napi::String::New(env, "GUINSOODB_NODEJS_ERROR"));
