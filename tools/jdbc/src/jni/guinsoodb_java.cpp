#include "org_guinsoodb_GuinsooDBNative.h"
...
JNIEXPORT jobject JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1startup(JNIEnv *env, jclass, jbyteArray database_j,
                                                                             jboolean read_only) {
	...
	try {
		auto db = new GuinsooDB(database, &config);
...
JNIEXPORT void JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1shutdown(JNIEnv *env, jclass, jobject db_ref_buf) {
	auto db_ref = (GuinsooDB *)env->GetDirectBufferAddress(db_ref_buf);
	if (db_ref) {
		delete db_ref;
	}
}

JNIEXPORT jobject JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1connect(JNIEnv *env, jclass, jobject db_ref_buf) {
	auto db_ref = (GuinsooDB *)env->GetDirectBufferAddress(db_ref_buf);
	try {
...
JNIEXPORT void JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1set_1auto_1commit(JNIEnv *env, jclass,
...
JNIEXPORT jboolean JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1get_1auto_1commit(JNIEnv *env, jclass,
                                                                                        jobject conn_ref_buf) {
	auto conn_ref = (Connection *)env->GetDirectBufferAddress(conn_ref_buf);
	if (!conn_ref) {
		env->ThrowNew(env->FindClass("java/sql/SQLException"), "Invalid connection");
...
JNIEXPORT void JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1disconnect(JNIEnv *env, jclass,
                                                                             jobject conn_ref_buf) {
	auto conn_ref = (Connection *)env->GetDirectBufferAddress(conn_ref_buf);
	if (conn_ref) {
		delete conn_ref;
...
JNIEXPORT jobject JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1prepare(JNIEnv *env, jclass, jobject conn_ref_buf,
                                                                             jbyteArray query_j) {
	auto conn_ref = (Connection *)env->GetDirectBufferAddress(conn_ref_buf);
	if (!conn_ref) {
		env->ThrowNew(env->FindClass("java/sql/SQLException"), "Invalid connection");
...
JNIEXPORT jobject JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1execute(JNIEnv *env, jclass, jobject stmt_ref_buf,
                                                                             jobjectArray params) {
	...
	if (param_len > 0) {
		...
		for (idx_t i = 0; i < param_len; i++) {
			...
			if (param == nullptr) {
				guinsoodb_params.push_back(Value());
				continue;
			} else if (env->IsInstanceOf(param, bool_class)) {
				guinsoodb_params.push_back(
				...
				guinsoodb_params.push_back(Value(param_string));
	...
	res_ref->res = stmt_ref->stmt->Execute(guinsoodb_params, false);
...
JNIEXPORT void JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1release(JNIEnv *env, jclass, jobject stmt_ref_buf) {
	auto stmt_ref = (StatementHolder *)env->GetDirectBufferAddress(stmt_ref_buf);
	if (stmt_ref) {
		delete stmt_ref;
	}
...
JNIEXPORT void JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1free_1result(JNIEnv *env, jclass,
                                                                               jobject res_ref_buf) {
...
JNIEXPORT jobject JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1meta(JNIEnv *env, jclass, jobject stmt_ref_buf) {
	...
	jclass meta = env->FindClass("org/guinsoodb/GuinsooDBResultSetMetaData");
...
JNIEXPORT jobjectArray JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1fetch(JNIEnv *env, jclass,
                                                                                jobject res_ref_buf) {
	auto res_ref = (ResultHolder *)env->GetDirectBufferAddress(res_ref_buf);
	...
	auto vec_array = (jobjectArray)env->NewObjectArray(res_ref->chunk->ColumnCount(),
	                                                   env->FindClass("org/guinsoodb/GuinsooDBVector"), nullptr);
	for (idx_t col_idx = 0; col_idx < res_ref->chunk->ColumnCount(); col_idx++) {
		...
		jclass vec_class = env->FindClass("org/guinsoodb/GuinsooDBVector");
...
JNIEXPORT jint JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1fetch_1size(JNIEnv *, jclass) {
	return STANDARD_VECTOR_SIZE;
}

JNIEXPORT jstring JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1prepare_1type(JNIEnv *env, jclass,
...
JNIEXPORT jobject JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1create_1appender(JNIEnv *env, jclass,
                                                                                      jobject conn_ref_buf,
...
JNIEXPORT void JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1appender_1begin_1row(JNIEnv *env, jclass,
...
JNIEXPORT void JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1appender_1end_1row(JNIEnv *env, jclass,
                                                                                     jobject appender_ref_buf) {
	try {
...
JNIEXPORT void JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1appender_1flush(JNIEnv *env, jclass,
                                                                                  jobject appender_ref_buf) {
	try {
...
JNIEXPORT void JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1appender_1close(JNIEnv *env, jclass,
                                                                                  jobject appender_ref_buf) {
	try {
...
JNIEXPORT void JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1appender_1append_1boolean(JNIEnv *env, jclass,
                                                                                            jobject appender_ref_buf,
                                                                                            jboolean value) {
	try {
...
JNIEXPORT void JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1appender_1append_1byte(JNIEnv *env, jclass,
                                                                                         jobject appender_ref_buf,
                                                                                         jbyte value) {
	try {
...
JNIEXPORT void JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1appender_1append_1short(JNIEnv *env, jclass,
                                                                                          jobject appender_ref_buf,
                                                                                          jshort value) {
	try {
...
JNIEXPORT void JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1appender_1append_1int(JNIEnv *env, jclass,
                                                                                        jobject appender_ref_buf,
                                                                                        jint value) {
	try {
...
JNIEXPORT void JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1appender_1append_1long(JNIEnv *env, jclass,
                                                                                         jobject appender_ref_buf,
                                                                                         jlong value) {
	try {
...
JNIEXPORT void JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1appender_1append_1float(JNIEnv *env, jclass,
                                                                                          jobject appender_ref_buf,
                                                                                          jfloat value) {
	try {
...
JNIEXPORT void JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1appender_1append_1double(JNIEnv *env, jclass,
                                                                                           jobject appender_ref_buf,
                                                                                           jdouble value) {
	try {
...
JNIEXPORT void JNICALL Java_org_guinsoodb_GuinsooDBNative_guinsoodb_1jdbc_1appender_1append_1string(JNIEnv *env, jclass,
                                                                                           jobject appender_ref_buf,
                                                                                           jbyteArray value) {
	try {
