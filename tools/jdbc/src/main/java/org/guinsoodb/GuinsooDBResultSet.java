...
public class GuinsooDBResultSet implements ResultSet {

	private GuinsooDBPreparedStatement stmt;
	private GuinsooDBResultSetMetaData meta;

	private ByteBuffer result_ref;
	private GuinsooDBVector[] current_chunk;
	private int chunk_idx = 0;
	private boolean finished = false;
	private boolean was_null;

	public GuinsooDBResultSet(GuinsooDBPreparedStatement stmt, GuinsooDBResultSetMetaData meta, ByteBuffer result_ref) {
		this.stmt = stmt;
		this.result_ref = result_ref;
		this.meta = meta;
		current_chunk = GuinsooDBNative.guinsoodb_jdbc_fetch(result_ref);
	...
	public synchronized void close() throws SQLException {
		if (result_ref != null) {
			GuinsooDBNative.guinsoodb_jdbc_free_result(result_ref);
			result_ref = null;
		}
		stmt = null;
		meta = null;
