...
public class GuinsooDBPreparedStatement implements PreparedStatement {
	private GuinsooDBConnection conn;

	private ByteBuffer stmt_ref = null;
	private GuinsooDBResultSet select_result = null;
	private int update_result = 0;
	private boolean is_update = false;
	private Object[] params = new Object[0];
	private GuinsooDBResultSetMetaData meta = null;

	public GuinsooDBPreparedStatement(GuinsooDBConnection conn) throws SQLException {
		if (conn == null) {
	...
	public GuinsooDBPreparedStatement(GuinsooDBConnection conn, String sql) throws SQLException {
		if (conn == null) {
			throw new SQLException("connection parameter cannot be null");
		}
		if (sql == null) {
	...
	private void prepare(String sql) throws SQLException {
		...
		stmt_ref = GuinsooDBNative.guinsoodb_jdbc_prepare(conn.conn_ref, sql.getBytes(StandardCharsets.UTF_8));
		meta = GuinsooDBNative.guinsoodb_jdbc_meta(stmt_ref);
		params = new Object[0];
		// TODO add query type to meta
		String query_type = GuinsooDBNative.guinsoodb_jdbc_prepare_type(stmt_ref);
	...
	public boolean execute() throws SQLException {
		...
		ByteBuffer result_ref = GuinsooDBNative.guinsoodb_jdbc_execute(stmt_ref, params);
		select_result = new GuinsooDBResultSet(this, meta, result_ref);
	...
	public ParameterMetaData getParameterMetaData() throws SQLException {
		...
		return new GuinsooDBParameterMetaData(meta);
	}
	...
	public void close() throws SQLException {
		if (stmt_ref != null) {
			GuinsooDBNative.guinsoodb_jdbc_release(stmt_ref);
			stmt_ref = null;
		}
	...
	public int getFetchSize() throws SQLException {
		return GuinsooDBNative.guinsoodb_jdbc_fetch_size();
	}
