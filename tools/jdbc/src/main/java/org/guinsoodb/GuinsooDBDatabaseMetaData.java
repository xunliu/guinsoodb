...
public class GuinsooDBDatabaseMetaData implements DatabaseMetaData {
	GuinsooDBConnection conn;

	public GuinsooDBDatabaseMetaData(GuinsooDBConnection conn) {
		this.conn = conn;
	}
	...
	public ResultSet getColumns(String catalog, String schemaPattern, String tableNamePattern, String columnNamePattern)
		...
		while (rs.next()) {
			values_str += ", ('" + rs.getString(1) + "', "
					+ Integer.toString(GuinsooDBResultSetMetaData.type_to_int(rs.getString(1))) + ")";
		}
		rs.close();
