...
public class GuinsooDBConnection implements java.sql.Connection {
	protected ByteBuffer conn_ref = null;
	protected GuinsooDBDatabase db;

	public GuinsooDBConnection(GuinsooDBDatabase db) throws SQLException {
		if (db.db_ref == null) {
			throw new SQLException("Database was shutdown");
		}
		conn_ref = GuinsooDBNative.guinsoodb_jdbc_connect(db.db_ref);
		GuinsooDBNative.guinsoodb_jdbc_set_auto_commit(conn_ref, true);
		this.db = db;
	}
	...
	public Statement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability)
		...
		if (resultSetConcurrency == ResultSet.CONCUR_READ_ONLY && resultSetType == ResultSet.TYPE_FORWARD_ONLY) {
			return new GuinsooDBPreparedStatement(this);
		}
	...
	public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency,
		...
		if (resultSetConcurrency == ResultSet.CONCUR_READ_ONLY && resultSetType == ResultSet.TYPE_FORWARD_ONLY) {
			return new GuinsooDBPreparedStatement(this, sql);
		}
		throw new SQLFeatureNotSupportedException();
	}
	...
	public GuinsooDBDatabase getDatabase() {
		return db;
	}
	...
	public synchronized void close() throws SQLException {
		if (conn_ref != null) {
			GuinsooDBNative.guinsoodb_jdbc_disconnect(conn_ref);
			conn_ref = null;
		}
		db = null;
	}
	...
	public void setAutoCommit(boolean autoCommit) throws SQLException {
		...
		GuinsooDBNative.guinsoodb_jdbc_set_auto_commit(conn_ref, autoCommit);
	}
	...
	public boolean getAutoCommit() throws SQLException {
		...
		return GuinsooDBNative.guinsoodb_jdbc_get_auto_commit(conn_ref);
	}
	...
	public DatabaseMetaData getMetaData() throws SQLException {
		return new GuinsooDBDatabaseMetaData(this);
	}
	...
	public GuinsooDBAppender createAppender(String schemaName, String tableName) throws SQLException {
		return new GuinsooDBAppender(this, schemaName, tableName);
	}
}
