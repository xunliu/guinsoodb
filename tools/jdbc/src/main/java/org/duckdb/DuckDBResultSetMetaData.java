...
public class GuinsooDBResultSetMetaData implements ResultSetMetaData {

	public GuinsooDBResultSetMetaData(int param_count, int column_count, String[] column_names, String[] column_types) {
