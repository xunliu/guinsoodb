...
guinsoodb_nonsense_db = 'guinsoodbtest_nonsensedb.db'
with open(guinsoodb_nonsense_db, 'w+') as f:
     f.write('blablabla')
test('', err='unable to open', extra_commands=[guinsoodb_nonsense_db])
os.remove(guinsoodb_nonsense_db)
...
target_dir = 'guinsoodb_shell_test_export_dir'
try:
...
guinsoodb_nonsensecsv = 'guinsoodbtest_nonsensecsv.csv'
with open(guinsoodb_nonsensecsv, 'wb+') as f:
     f.write(b'\xFF\n')
test('''
.nullvalue NULL
CREATE TABLE test(i INTEGER);
.import guinsoodbtest_nonsensecsv.csv test
SELECT * FROM test;
''', out="NULL")
os.remove(guinsoodb_nonsensecsv)
