...
if len(sys.argv) < 2 or not os.path.isfile(sys.argv[1]):
	print("Usage: [libguinsoodb dynamic library file, release build]")
	exit(1)
...
'N6guinsoodb', 'guinsoodb::', 'guinsoodb_miniz::', 'guinsoodb_fmt::', 'guinsoodb_hll::', 'guinsoodb_moodycamel::', 'guinsoodb_',
